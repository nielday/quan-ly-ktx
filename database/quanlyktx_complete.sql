-- ============================================
-- SQL SCRIPT HOÀN CHỈNH TẠO DATABASE HỆ THỐNG QUẢN LÝ KÝ TÚC XÁ
-- File này gộp: quanlyktx.sql + migration_add_deposit_support.sql + seed_data.sql
...
-- ============================================
-- 12. BẢNG PAYMENTS (Thanh toán) - ĐÃ CẬP NHẬT với hỗ trợ tiền đặt cọc
-- ============================================
CREATE TABLE payments (
    id INT AUTO_INCREMENT PRIMARY KEY,
    invoice_id INT NULL COMMENT 'Thanh toán cho hóa đơn nào (NULL nếu là tiền đặt cọc)',
    contract_id INT NULL COMMENT 'Liên kết với hợp đồng (cho tiền đặt cọc)',
    payment_type ENUM('invoice_payment', 'deposit', 'refund') DEFAULT 'invoice_payment' COMMENT 'Loại thanh toán',
    student_id INT NOT NULL,
...
SELECT 'Database đã được tạo thành công với đầy đủ dữ liệu mẫu!' as message;
SELECT '18 bảng đã được tạo:' as info;
SELECT '1. users, 2. buildings, 3. rooms, 4. pricing, 5. registration_periods' as tables;
SELECT '6. students, 7. applications, 8. contracts, 9. room_assignments, 10. room_transfer_requests' as tables;
SELECT '11. invoices, 12. payments (với hỗ trợ tiền đặt cọc), 13. services, 14. room_services' as tables;
SELECT '15. service_registrations, 16. violations, 17. maintenance_requests, 18. notifications' as tables;
