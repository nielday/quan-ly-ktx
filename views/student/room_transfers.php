<?php
/**
 * Danh sách yêu cầu chuyển phòng - Student
 */
...
<head>
    ...
    <title>Yêu cầu chuyển phòng - Sinh viên</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="bi bi-arrow-left-right me-2"></i>Yêu cầu chuyển phòng</h2>
            <div>
                <a href="room_transfers/create.php" class="btn btn-primary me-2">
            ...
            <div class="card-body">
                <?php if (empty($requests)): ?>
                    <div class="alert alert-info">
                        <i class="bi bi-info-circle me-2"></i>Bạn chưa có yêu cầu chuyển phòng nào.
                    </div>
                <?php else: ?>
                            ...
                            <tbody>
                                <?php foreach ($requests as $request): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($request['current_room_code']): ?>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <span class="text-muted">Chỉ muốn chuyển đi</span>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <small><?php echo escapeHtml(substr($request['reason'], 0, 50)); ?><?php echo strlen($request['reason']) > 50 ? '...' : ''; ?></small>
                                        </td>
                                        <td>
                                            <?php
                                            $statusClass = [
