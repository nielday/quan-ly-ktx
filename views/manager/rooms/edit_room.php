...
<head>
    ...
    <title>Sửa Phòng - Quản lý KTX</title>
            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="bi bi-pencil me-2"></i>Sửa Phòng
                        </h5>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="../../../../handle/rooms_process.php">
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-select" id="building_id" name="building_id" required>
                                        ...
                                        <?php foreach ($buildings as $building): ?>
                                            <option value="<?php echo $building['id']; ?>" 
                                                    <?php echo ($room['building_id'] == $building['id']) ? 'selected' : ''; ?>>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="room_code" 
                                           name="room_code" 
                                           value="<?php echo escapeHtml($room['room_code']); ?>"
                                           required
                                           maxlength="20">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="room_number" 
                                           name="room_number" 
                                           value="<?php echo escapeHtml($room['room_number']); ?>"
                                           required
                                           maxlength="20">
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="floor" 
                                           name="floor" 
                                           value="<?php echo escapeHtml($room['floor']); ?>"
                                           min="1"
                                           max="50">
                                </div>
                                    ...
                                    <select class="form-select" id="room_type" name="room_type" required onchange="updateCapacity()">
                                        ...
                                        <?php foreach ($roomTypes as $key => $label): ?>
                                            <option value="<?php echo escapeHtml($key); ?>" 
                                                    <?php echo ($room['room_type'] == $key) ? 'selected' : ''; ?>>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="capacity" 
                                           name="capacity" 
                                           value="<?php echo escapeHtml($room['capacity']); ?>"
                                           min="1"
                                           max="10"
                                           required>
                                    <div class="form-text">
                                        Hiện tại có <?php echo $room['current_occupancy']; ?> người đang ở. 
                                        Sức chứa mới không được nhỏ hơn số này.
                                    </div>
                                </div>
                                    ...
                                    <select class="form-select" id="status" name="status">
                                        <?php foreach ($roomStatuses as $key => $label): ?>
                                            <option value="<?php echo $key; ?>" 
                                                    <?php echo ($room['status'] == $key) ? 'selected' : ''; ?>>
                                                <?php echo escapeHtml($label); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" 
                                          id="amenities" 
                                          name="amenities" 
                                          rows="3"><?php echo escapeHtml($room['amenities'] ?? ''); ?></textarea>
                                <div class="form-text">Liệt kê các tiện ích của phòng, cách nhau bởi dấu phẩy</div>
                            </div>

                            <div class="alert alert-info">
                                <strong>Thông tin hiện tại:</strong><br>
                                - Giá phòng: <?php echo formatCurrency($room['price_per_month'] ?? 0); ?>/tháng<br>
                                - Số người đang ở: <?php echo $room['current_occupancy']; ?>/<?php echo $room['capacity']; ?>
                            </div>
