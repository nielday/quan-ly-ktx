...
<head>
    ...
    <title>Thêm Tòa nhà mới - Quản lý KTX</title>
                        ...
                        <form method="POST" action="../../../../handle/buildings_process.php">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" 
                                          ...
                                          name="address" 
                                          rows="2"
                                          placeholder="Nhập địa chỉ tòa nhà"></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" 
                                          ...
                                          name="description" 
                                          rows="3"
                                          placeholder="Mô tả về tòa nhà, tiện ích chung..."></textarea>
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-circle me-2"></i>Thêm tòa nhà
                                </button>
                            </div>
                        </form>
                    </div>
